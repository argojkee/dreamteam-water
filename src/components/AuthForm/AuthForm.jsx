  ...
  return (
       ...
       <Styles $div $justify={'center'}>
          ...
          <Styles $div $divDiraction={'column'} height={'312px'} width={'384px'}>
            ...
            <Styles $p $fontSize={'26px'} $marginBott={'16px'}>Sign In</Styles>

            <Styles onSubmit={formik.handleSubmit} $form $formDiraction={'column'}>

            <Styles $label htmlFor="email"><Styles $p $fontWeight={'400'}>Enter your email</Styles></Styles>
                <Styles $input $borderRadius={'6px'} $marginBott={'16px'}
              ...
              <Styles $label htmlFor="password"><Styles $p $fontWeight={'400'}>Enter your password</Styles></Styles>
              ...
              {isRegistrationPage  && 
                <>
                    <Styles $label htmlFor="repeatPassword"><Styles $p $fontWeight={'400'}>Repeat password</Styles></Styles>
                    <Styles $input $borderRadius={'6px'}
                        id="repeatPassword"
                        name="repeatPassword"
                        type="password"
              ...
              <Styles $button type="submit" $borderRadius={'10px'}>Submit</Styles>
            </Styles>

            <Styles $link onClick={navTo}> To {isRegistrationPage ? 'login' : 'registration'} page{' '}</Styles>
