...
const Section = styled.section`
  ...
  width: 100vw;
    ...
    @media screen and (min-width: 320px) and (max-width: 767px) { 
      ...
      background-position: 0 10px, ${props =>
        props.$bottleSize.x - props.$bottleSize.width / 2}px ${props =>
  props.$bottleSize.y + props.$bottleSize.height / 3}px;
    
      @media (min-device-pixel-ratio: 2),(min-resolution: 192dpi),(min-resolution: 2dppx) {
        background: url(${BackMobile2}), url(${Back2Mobile2});
        background-repeat: no-repeat, no-repeat;
        background-size: cover, ${props => props.$bottleSize.width * 2}px;
        background-position: 0 50px, ${props =>
          props.$bottleSize.x - props.$bottleSize.width / 2}px ${props =>
  props.$bottleSize.y + props.$bottleSize.height / 3}px;
      }
    }
    ...
    @media screen and (min-width: 768px) and (max-width: 1279px) { 
      ...
      background-position: 0 10px, ${props =>
        props.$bottleSize.x - props.$bottleSize.width / 2}px ${props =>
  props.$bottleSize.y + props.$bottleSize.height / 2}px;
    
      @media (min-device-pixel-ratio: 2),(min-resolution: 192dpi),(min-resolution: 2dppx) {
        background: url(${BackTablet2}), url(${Back2Tablet2});
        background-repeat: no-repeat, no-repeat;
        background-size: cover, ${props => props.$bottleSize.width * 2}px;
        background-position: 0 3px, ${props =>
          props.$bottleSize.x - props.$bottleSize.width / 2}px ${props =>
  props.$bottleSize.y + props.$bottleSize.height / 2}px;
      }
    }
    ...
    @media screen and (min-width: 1280) { 
      ...
      background-position: 0 10px, ${props =>
        props.$bottleSize.x - props.$bottleSize.width / 2}px ${props =>
  props.$bottleSize.y + props.$bottleSize.height / 2};
