...
const DaysGeneralStats = ({ setModalVisible, top, left, selectedMonth, statistic }) => {
...
useEffect(() => {
  ...
  return (
      ...
      <p>Daily norma: <span>{statistic[selectedMonth.day-1].norm/1000}L</span></p>
          <p>Fulfillment of the daily norm: <span>{statistic[selectedMonth.day-1].percent}%</span></p>
